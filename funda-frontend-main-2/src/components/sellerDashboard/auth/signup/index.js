...
import Logo from "../../../../assets/kmmart-logo/favicon-white-transparent.png";
...
const SellerSignup = () => {
  ...
  return (
    <>
      <section className="seller-register-wrapper auth-wrapper">
        <form
        ...
        >
          ...
          <div className="tagline">Signup as seller</div>
          <TextField
            name="fullName"
            value={fullName}
            onChange={onChange}
